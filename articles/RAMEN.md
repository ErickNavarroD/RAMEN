...
indicated in the *permutations* parameter.
...
#> 6      VML8     0.5316458           G     0.4508688       145.0785           1
```
...
set.](RAMEN_files/figure-html/unnamed-chunk-15-1.png)
...
#> $ r2_difference_basal <dbl> 0.6818694, 0.4875988, 0.7034360, 0.7347274
```

We can see that the final data set in this example dropped almost all of
the VMRs we had (only `4`/`118` survived!). This is something expected
